...
public class ServicioActualizarUsuarioTest {
    ...
    void deberiaValidarLaExistenciaPreviaDelUsuarioConId() {
        // arrange
        ...
        // act - assert
        BasePrueba.assertThrows(() -> servicioActualizarUsuario.ejecutar(usuario), ExcepcionDuplicidad.class,"El id no existe en el sistema");
    }
